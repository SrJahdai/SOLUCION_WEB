...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            data.estrenos.forEach(pelicula => {
                slider.append(`
                    <aside class="escaparate" data-id="${pelicula.id}">

                    <img src="${pelicula.portada}" alt="${pelicula.titulo}" style="min-width: 100%; min-height: 100%; z-index: 1;">
                        <div class="row">
                            <col-2>
            ...
            data.recientes.forEach(p => {
                recientesContainer.append(`
                        <div class="peliculaShow " data-id="${p.id}">
    ...
    $(document).on('click', '.peliculaShow, .escaparate', function () {
        const peliculaId = $(this).data('id');
        if (peliculaId) {
            window.location.href = `/Usuario/Detalles/${peliculaId}`;
        }
    });
